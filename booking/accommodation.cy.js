describe('Accommodation Booking', () => {
  it('Book from OTA Search', () => {
    ...
    cy.get('.ota-search-accommodation')
      .should('be.visible')
    ...
    cy.get('#el-id-1024-11')
      .should('be.visible')
    // Choose the date for the start date
    cy.get('#el-id-1024-11 > .el-picker-panel > .el-picker-panel__body-wrapper > .el-picker-panel__body > .is-right > .el-date-table > tbody > :nth-child(2) > :nth-child(6) > .el-date-table-cell')
      .click()
    // Choose the date for the end date
    cy.get('#el-id-1024-11 > .el-picker-panel > .el-picker-panel__body-wrapper > .el-picker-panel__body > .is-right > .el-date-table > tbody > :nth-child(2) > :nth-child(7) > .el-date-table-cell')
      .click()
    // Add the Guest Number
    // Click to display the guest data form
    cy.get('.ota-search-accommodation > :nth-child(3) > .au-popover > .cursor-pointer > .rounded-lg')
      .click() 
    ...
    // Go to detail page
    cy.visit('https://wandr.freya.travlr.com/accommodation/detail/broome-time-resort?HotelCode=015770604&CheckIn=2025-07-04&CheckOut=2025-07-05&CurrencyCode=AUD&Provider=Expedia&GuestCounts[0][0][AgeQualifyingCode]=10&GuestCounts[0][0][Count]=3&GuestCounts[0][0][Age]=25&GuestCounts[0][1][AgeQualifyingCode]=8&GuestCounts[0][1][Count]=1&GuestCounts[0][1][Age]=7')
    cy.wait(5000)
